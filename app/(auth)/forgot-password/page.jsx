    ...
    return (
        <div className="w-full items-center flex justify-center bg-[url('/bg_login.png')] bg-cover bg-center h-screen">
            <div className="flex flex-col gap-4 border p-4 rounded-xl bg-[#DAE7DD]">
                <h1 className="text-3xl text-blue-500">Forgot-pass</h1>
                <label className="input input-bordered flex items-center gap-2">
                    ...
                    <input type="text" className=" bg-green-500" placeholder="Enter your registered Email" value={email} onChange={(e) => setEmail(e.target.value)}/>
                </label>
                <button className="btn bg-blue-500 hover:bg-green-600 text-white">SendOTP</button>
                {/* <label className="input input-bordered flex items-center gap-2">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 16 16"
